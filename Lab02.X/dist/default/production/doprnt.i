 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 628 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 644 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
   {
    prec = 0;
...
# 1138 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
     if(prec <= 12)
    ...
    for(c = 1 ; c != (sizeof dpowers/sizeof dpowers[0]) ; c++)
     if(val < dpowers[c])
      break;
# 1201 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
    {
# 1214 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
    if(flag & 0x03)
...
# 1316 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
# 1365 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
  if(c < prec)
   c = (char)prec;
  else if(prec < c)
   prec = c;
...
# 1559 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\sources\\c90\\common\\doprnt.c"
 }
